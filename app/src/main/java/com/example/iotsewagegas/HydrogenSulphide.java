 ...
 */
public class HydrogenSulphide extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        lineChart=view.findViewById(R.id.linechart_hydrogensulphide);
        requestQueue= Volley.newRequestQueue(getContext());
        progressBar=view.findViewById(R.id.prog_h2s);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        if(jsonObject.getString("field5")!="null"){
                            ...
                            con_values.add(new Entry(j,jsonObject.getInt("field5")));
                            j++;
                        }
                    }
                    LineDataSet set = new LineDataSet(con_values,"Hydrogen Sulphide");
                    set.setLineWidth(2f);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_hydrogen_sulphide, container, false);
    }
