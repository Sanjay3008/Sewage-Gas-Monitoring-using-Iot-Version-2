 ...
 */
public class CarbonMonoxide extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        lineChart=view.findViewById(R.id.linechart_carbonmonoxide);
        requestQueue= Volley.newRequestQueue(getContext());
        progressBar=view.findViewById(R.id.prog_co);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        if(jsonObject.getString("field1")!="null"){
                            ...
                            con_values.add(new Entry(j,jsonObject.getInt("field1")));
                            j++;
                        }
                    }
                    LineDataSet set = new LineDataSet(con_values,"Carbonmonoxide");
                    set.setLineWidth(2f);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_carbon_monoxide, container, false);
    }
