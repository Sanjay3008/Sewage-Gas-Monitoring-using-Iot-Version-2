 ...
 */
public class Methane extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        lineChart=view.findViewById(R.id.linechart_methane);
        requestQueue= Volley.newRequestQueue(getContext());
        progressBar=view.findViewById(R.id.prog_ch4);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        if(jsonObject.getString("field3")!="null"){
                            ...
                            con_values.add(new Entry(j,jsonObject.getInt("field3")));
                            j++;
                        }
                    }
                    LineDataSet set = new LineDataSet(con_values,"Methane");
                    set.setLineWidth(2f);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_methane, container, false);
    }
