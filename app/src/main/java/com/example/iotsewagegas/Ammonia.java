 ...
 */
public class Ammonia extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        lineChart=view.findViewById(R.id.linechart_ammonia);
        requestQueue= Volley.newRequestQueue(getContext());
        progressBar=view.findViewById(R.id.prog_ch3);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        if(jsonObject.getString("field4")!="null"){
                            ...
                            con_values.add(new Entry(j,jsonObject.getInt("field4")));
                            j++;
                        }
                    }
                    LineDataSet set = new LineDataSet(con_values,"Ammonia");
                    set.setLineWidth(2f);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_ammonia, container, false);
    }
